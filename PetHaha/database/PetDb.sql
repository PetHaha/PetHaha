...
insert into pmessage(msnum,tonick,id,nick,mcontent,answer,mcheck,mtitle)
values(pmessage_seq.nextVal,'대의대의','yijin','이진이진','안녕하세요 안녕하세요 반갑습니다 안녕하세요 반갑습니다','네 반가워요','0','안녕하세요 반갑습니다!!');

insert into pmessage(msnum,tonick,id,nick,mcontent,answer,mcheck,mtitle)
values(pmessage_seq.nextVal,'이진이진','daeui','대의대의','저 기억하시죠???','누구시죠?','1','안녕하세요 반갑습니다');