...
<form  action="replyReport" method="post"  name="reportform">
    <div class="police">
        <h2 style="text-align: center; color:#dbadff">댓글 신고</h2>
            ...
            <tr style="border: 1px solid #dbadff;">
                ...
                <td style="border:1px solid #dbadff;">
                    <select class="policeselect" name="RCATEGORY">
                        <option value="1">게시글과 무관한 내용의 댓글</option>
                        <option value="2">선정적인 댓글</option>
                        <option value="3">정치/선동 댓글</option>
                        <option value="4">중복 댓글</option>      
                    </select>
                </td>
            </tr>
            <tr>
